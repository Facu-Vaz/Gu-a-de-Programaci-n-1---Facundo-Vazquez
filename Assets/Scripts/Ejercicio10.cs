...
//Nos piden desarrollar un  programa que informe si un 
//estacionamiento se encuentra o no abierto según la hora  ingresada por el usuario.
...
//según corresponda, e informar por  pantalla mediante la misma si el estacionamiento 
//se encuentra abierto o no.Obs: En el caso de que el valor de la variable correspona 
//a una hora menor a 0 o mayor a 24, mostrar el  mensaje: “Ha ingresado una hora incorrecta” 
...
public class Ejercicio10 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            if (estaAbierto)
            {
                Debug.Log("Estacionamiento abierto");
            }
            else
            {
                Debug.Log("Estacionamiento cerrado");
            }
        }
    }
